	...
	computed: {
		orientationStyle: function(){
			if (this.orientation == 0){
				...
				document.getElementById("game").style.backgroundImage = "url(background1.jpg)";
				return {borderRightColor: "FF0000"};
			}
			else if (this.orientation == 2){
				document.getElementById("game").style.backgroundImage = "url(background2.png)";
				return {borderBottomColor: "FF0000"};
			}
			else if (this.orientation == 3){
				document.getElementById("game").style.backgroundImage = "url(background3.png)";
